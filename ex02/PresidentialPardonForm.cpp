...
PresidentialPardonForm::PresidentialPardonForm() : AForm(), _target("Marvin") {}

PresidentialPardonForm::PresidentialPardonForm(const std::string& target) : AForm("Pardon-Form", 25, 5), _target(target) {}
